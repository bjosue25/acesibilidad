window.onload = () => {
    ...
    document
      ...
      .addEventListener("click", e=>validateForm);
  ...
  function listenforesc(e){if(e.keycode===27){closeModal(e)}
  ...
  function showNotification() {
    document.getElementById("name-error").innerHTML = "";
      ...
      document.querySelector(".notification").innerHTML= "El formulario fue enviado exitosamente";
